...
object Widgets {
    ...
    const val CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_RETRO = 621 
    const val CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_RETRO = 622
    const val CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_RETRO = 623
